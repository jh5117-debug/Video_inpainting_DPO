...
| EffectErase VOR-Eval | held-out object-removal baseline | VOR-Eval 43 rows | weak/mixed baseline | 43/43 review summary; representatives opened | held-out weak baseline only | baseline diagnostic | adapter evidence; DPO loser source; strong baseline | none without separate authorization |
