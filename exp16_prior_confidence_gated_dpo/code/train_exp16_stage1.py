...
def append_dpo_diagnostics_csv(output_dir, step, diag, grad_norm=None):
    ...
    row = {
        ...
        "prior_conf_mean_inside_mask": diag.get("prior_conf_mean_inside_mask"),
        "prior_conf_std_inside_mask": diag.get("prior_conf_std_inside_mask"),
        "prior_conf_p10_inside_mask": diag.get("prior_conf_p10_inside_mask"),
        "prior_conf_p50_inside_mask": diag.get("prior_conf_p50_inside_mask"),
        "prior_conf_p90_inside_mask": diag.get("prior_conf_p90_inside_mask"),
        "reliable_area_ratio": diag.get("reliable_area_ratio"),
        "generate_area_ratio": diag.get("generate_area_ratio"),
        "reliable_weight_mass": diag.get("reliable_weight_mass"),
        "generate_weight_mass": diag.get("generate_weight_mass"),
        "reliable_generate_mass_sum": diag.get("reliable_generate_mass_sum"),
        "confidence_alpha": diag.get("confidence_alpha"),
