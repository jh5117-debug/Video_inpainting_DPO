...
"${PYTHON}" exp19r0_flow_adapter_calibration/code/run_exp19r0_sweep.py \
  ...
  --save_path /mnt/nas/hj/H20_Video_inpainting_DPO/logs/target_eval/exp19r0_flow_adapter_calibration/sweep \
  ...
  --compute_lpips \
  --compute_ewarp \
  --raft_model_path /mnt/nas/hj/data/third_party_video_inpainting/weights/propainter/raft-things.pth
