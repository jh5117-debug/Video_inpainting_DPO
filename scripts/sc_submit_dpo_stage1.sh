...
export PROJECT_ASSET_ROOT="${PROJECT_ASSET_ROOT:-${PROJECT_HOME}/H20_Video_inpainting_DPO}"
export PROJECT_DATA="${PROJECT_DATA:-${PROJECT_ASSET_ROOT}/data}"
...
export WEIGHTS_DIR="${WEIGHTS_DIR:-${PROJECT_ASSET_ROOT}/weights}"
export EXPERIMENTS_DIR="${EXPERIMENTS_DIR:-${PROJECT_ASSET_ROOT}/experiments}"
