...
STAGE1_RUN_NAME="${EXP_NAME}_stage1_beta${BETA_LABEL}_${STAGE1_MAX_STEPS}"
STAGE2_RUN_NAME="${EXP_NAME}_stage2_beta${BETA_LABEL}_${STAGE2_MAX_STEPS}"
...
export SFT_REG_WEIGHT DPO_LOSE_GAP_WEIGHT LR LR_SCHEDULER LR_WARMUP GRAD_ACCUM BATCH_SIZE
