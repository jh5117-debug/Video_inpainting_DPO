...
export EXP_NAME="exp7_d2_comp_k4_partial_wingap_lose025_beta10_s1s2_gate1500"
...
# Exp7 is specifically the partial-mask task-alignment gate. Do not let stale
# shell exports from Exp5/Exp6 full-mask runs change these semantics.
