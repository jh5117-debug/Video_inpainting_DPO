...
export CONDA_ENV_PREFIX PYTHON_BIN
...
run_stage1() {
  ...
  export MAX_STEPS="${STAGE1_MAX_STEPS:-${MAX_STEPS:-2000}}" CKPT_STEPS="${CKPT_STEPS:-500}" CKPT_LIMIT="${CKPT_LIMIT:-5}" VAL_STEPS="${VAL_STEPS:-999999}" LOGGING_STEPS="${LOGGING_STEPS:-10}"
  ...
  export POLICY_INIT_PATH="${POLICY_INIT_PATH:-}" RESUME_FROM_CHECKPOINT="${RESUME_FROM_CHECKPOINT:-latest}"
  export REPORT_TO="${REPORT_TO:-none}" WANDB_PROJECT CONDA_ENV_PREFIX PYTHON_BIN DPO_ACCELERATE_PYTHON_BIN
  export LINGBOT_PROCESS_NAME PROCESS_TITLE DPO_STAGE1_ENTRYPOINT DPO_STAGE2_ENTRYPOINT
...
run_stage2() {
  ...
  export MAX_STEPS="${STAGE2_MAX_STEPS:-${MAX_STEPS:-2000}}" CKPT_STEPS="${CKPT_STEPS:-500}" CKPT_LIMIT="${CKPT_LIMIT:-5}" VAL_STEPS="${VAL_STEPS:-999999}" LOGGING_STEPS="${LOGGING_STEPS:-10}"
  export TRAIN_HEIGHT TRAIN_WIDTH RESOLUTION NFRAMES
  export BETA_DPO SFT_REG_WEIGHT LOSE_GAP_WEIGHT DPO_LOSE_GAP_WEIGHT="${LOSE_GAP_WEIGHT}"
  export WINNER_ABS_REG_WEIGHT WINNER_GAP_REG_WEIGHT WINNER_GAP_REG_MARGIN
  export REPORT_TO="${REPORT_TO:-none}" WANDB_PROJECT CONDA_ENV_PREFIX PYTHON_BIN DPO_ACCELERATE_PYTHON_BIN
