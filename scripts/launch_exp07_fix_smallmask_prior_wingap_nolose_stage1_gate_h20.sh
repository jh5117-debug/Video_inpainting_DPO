...
export EXP_NAME="${EXP_NAME:-exp07_fix_smallmask_prior_wingap_nolose_stage1_gate1000}"
...
mkdir -p "${OUTPUT_ROOT}/logs/train/${EXP_NAME}" "${OUTPUT_ROOT}/logs/pipelines" "${OUTPUT_ROOT}/reports"
{
  ...
  echo "[exp07-fix-h20] train_mask_mode=${TRAIN_MASK_MODE} mask_from_manifest=${MASK_FROM_MANIFEST}"
