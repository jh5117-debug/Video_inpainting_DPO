...
| `official_videodpo_diffueraser_task_partialmask_samemask_fullloss` | scaffold; reuses D2 | DiffuEraser | generated partial-mask data | VideoDPO winner | partialmask comp loser | partial | same partial mask | true | offline data | task | metric.py, SBS, DPO diagnostics | Experiment 7. First mask policy: `M_train = M_gen`; loss remains full-video DPO loss. |
| `official_videodpo_diffueraser_task_partialmask_samemask_regionloss` | scaffold; reuses D2 | DiffuEraser | generated partial-mask data | VideoDPO winner | partialmask comp loser | partial | same partial mask | true | offline data | task + loss | metric.py, SBS, DPO diagnostics | Experiment 8. Reuses D2 comp data and masks; loss weights mask / boundary / outside regions. |
