...
| Exp47 H20 MiniMax pseudo-success forensic | MiniMax | failure root-cause audit after Exp46 negative SFT30 | EXP47_REGION_LOSS_GLOBAL_DRIFT_RISK_CONFIRMED | Manifest passed; teacher is global/local-only; Step30 moves away from both; region loss has 0.824 outside+affected+base contribution, so localize before more SFT. |
