...
| Exp47 H20 MiniMax pseudo-success forensic | MiniMax | failure root-cause audit after Exp46 negative SFT30 | EXP47_READBACK_READY | Forensic only; no training/DPO/GT-only/100-step. |
