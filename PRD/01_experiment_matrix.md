...
| Exp47 H20 MiniMax pseudo-success forensic | MiniMax | failure root-cause audit after Exp46 negative SFT30 | EXP47_STEP30_MOVEMENT_AUDITED | Teacher audit found global/local-only targets; Step30 closer to pseudo/V_bg = 0/0, root signal SFT_LOSS_OR_TARGET_PATH_BUG; region-loss audit next. |
