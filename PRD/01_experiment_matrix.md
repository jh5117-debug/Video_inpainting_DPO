...
| Exp56-H20 | VOID local region-safe repair | Milestone A | `EXP56_H20_GPU_READY` | H20 lane only. GPU0-3 are available for R5_Q2_T500_S0 and R5_HALF_Q2_T500_S0 one-step cells. No 10-step. |
| Exp56-H20 | VOID local region-safe repair | Milestone C | `EXP56_H20_R5_ONESTEP_MIXED` | R5 and R5_HALF checkpoints/reloads/videos completed. Loser contribution is 0, outside safe, object improves, but overlap/affected/boundary regress beyond Exp56 gate. No 10-step. |
| Exp56-H20 | VOID local region-safe repair | Final | `EXP56_H20_ONESTEP_MIXED_ONLY` | Best H20 candidate is R5_Q2_T500_S0. Half-step did not fix transition-region regression. No one-step PASS; 10-step remains locked pending Exp57 aggregator. |
