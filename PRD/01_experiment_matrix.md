...
| Exp57 | VOID adaptive transition-safe DPO | PAI lane | `EXP57_PAI_ONESTEP_NEGATIVE` | PAI ATS_SDPO/ATS_LINEAR Q2/T500/S0 one-step cells completed with checkpoints, videos, metrics, and visual review. Best diagnostic was ATS_SDPO, but both cells failed one-step PASS; no 10-step. |
