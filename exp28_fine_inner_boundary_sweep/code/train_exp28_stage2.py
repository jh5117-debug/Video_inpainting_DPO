...
def parse_args(input_args=None):
    ...
    if str(args.exp28_geometry_mode or ""):
        ...
        if args.exp28_geometry_mode == "legacy_outer_one_ring" and int(args.inner_radius_px) != 0:
            raise ValueError("legacy_outer_one_ring requires inner_radius_px=0")
        if args.exp28_geometry_mode == "inner_boundary_px" and int(args.inner_radius_px) <= 0:
